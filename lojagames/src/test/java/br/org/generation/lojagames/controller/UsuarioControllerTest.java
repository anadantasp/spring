...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(new Usuario(0L, 
				"Paulo Antunes", "paulo_antunes@email.com.br", "13465278", dataNascimento));
	...
	@Test
	@Order(2)
	@DisplayName("Não deve permitir Usuário Menor de Idade")
	public void naoDevePermitirUsuarioMenor18() {
		
		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(new Usuario(0L, 
				"Maria da Silva", "maria_silva@email.com.br", "13465278", dataNascimentoMenor18));
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCreate = usuarioService.cadastrarUsuario(new Usuario(0L, 
			"Juliana Andrews", "juliana_andrews@email.com.br", "juliana123", dataNascimento));

		Usuario usuarioUpdate = new Usuario(usuarioCreate.get().getId(), 
			"Juliana Andrews Ramos", "juliana_ramos@email.com.br", "juliana123", dataNascimento);
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Sabrina Sanches", "sabrina_sanches@email.com.br", "sabrina123", dataNascimento));
			
		usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Ricardo Marques", "ricardo_marques@email.com.br", "ricardo123", dataNascimento));
	...
	public void deveDeletarUmUsuario() {
		...
		Optional<Usuario> usuarioDelete = usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Felícia Ramos", "felicia_ramos@email.com.br", "felicia123", dataNascimento));
