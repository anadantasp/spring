...
public class UsuarioControllerTest {
	...
	@Test
	@Order(3)
	@DisplayName("Atualizar um Usuários")
	public void deveAtualizarUsuario ()
	{
		Optional <Usuario> usuarioCreate = usuarioService.cadastrarUsuario(new Usuario (0L, "Ana Prado", "ana_prado@email.com.br", "anaprado123"));
		
		Usuario usuarioUpdate = new Usuario(usuarioCreate.get().getId(), "Ana Dantas", "ana_dantas@email.com.br", "anaprado123");
